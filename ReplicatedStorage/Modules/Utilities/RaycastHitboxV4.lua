...
____________________________________________________________________________________________________________________________________________________________________________
	...
	[ RaycastHitBox API ]
		...
		* HitboxObject.FirstPerson: boolean
				Description
					--- (Part of Visualizer) Adjusts the debug rays whether camera is in first person or not
					
		* HitboxObject.ThirdPerson: boolean
				Description
					--- (Part of Visualizer) Adjusts the debug rays whether camera is in third person or not
